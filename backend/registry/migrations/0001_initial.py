# Generated by Django 3.2.7 on 2021-12-21 13:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('ogcservice_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='registry.ogcservice')),
            ],
            options={
                'verbose_name': 'catalouge service',
                'verbose_name_plural': 'catalouge services',
            },
            bases=('registry.ogcservice',),
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_user', models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_wmsconformitycheckrun_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('last_modified_by', models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_wmsconformitycheckrun_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
                ('owner', models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_wmsconformitycheckrun_owner', to='auth.group', verbose_name='Owner')),
            ],
            options={
                'ordering': ['-created_at'],
                'get_latest_by': 'created_at',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_user', models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_timeextent_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ...
                ('last_modified_by', models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_timeextent_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
                ('owner', models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_timeextent_owner', to='auth.group', verbose_name='Owner')),
            ],
            options={
                'ordering': ['-created_at'],
                'get_latest_by': 'created_at',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_user', models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_style_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('last_modified_by', models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_style_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
                ...
                ('owner', models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_style_owner', to='auth.group', verbose_name='Owner')),
            ],
            options={
                'ordering': ['-created_at'],
                'get_latest_by': 'created_at',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_user', models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceauthentication_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('last_modified_by', models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceauthentication_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
                ('owner', models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceauthentication_owner', to='auth.group', verbose_name='Owner')),
                ('service', models.OneToOneField(blank=True, help_text='the optional authentication type and credentials to request the service.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auth', related_query_name='auth', to='registry.ogcservice', verbose_name='web map service')),
            ],
            options={
                'ordering': ['-created_at'],
                'get_latest_by': 'created_at',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_user', models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceaccessgroup_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('last_modified_by', models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceaccessgroup_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
                ('owner', models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceaccessgroup_owner', to='auth.group', verbose_name='Owner')),
            ],
            options={
                'ordering': ['-created_at'],
                'get_latest_by': 'created_at',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_user', models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_remotemetadata_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('last_modified_by', models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_remotemetadata_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
                ('owner', models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_remotemetadata_owner', to='auth.group', verbose_name='Owner')),
                ('service', models.ForeignKey(help_text='the service where this remote metadata is related to. This remote metadata was found in the GetCapabilites document of the related service.', on_delete=django.db.models.deletion.CASCADE, related_name='remote_metadata', related_query_name='remote_metadata', to='registry.ogcservice', verbose_name='web map service')),
            ],
            options={
                'ordering': ['-created_at'],
                'get_latest_by': 'created_at',
        ...
        migrations.AddField(
            model_name='proxysetting',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_proxysetting_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='operationurl',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_operationurl_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='operationurl',
            name='service',
            field=models.ForeignKey(editable=False, help_text='the web map service for that this url can be used for.', on_delete=django.db.models.deletion.CASCADE, related_name='operation_urls', related_query_name='operation_url', to='registry.ogcservice', verbose_name='related web map service'),
        ),
        migrations.AddField(
            model_name='ogcservice',
            name='created_by_user',
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_ogcservice_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='ogcservice',
            name='keywords',
            field=models.ManyToManyField(help_text='all keywords which are related to the content of this metadata.', related_name='ogcservice_metadata', related_query_name='ogcservice_metadata', to='registry.Keyword', verbose_name='keywords'),
        ),
        migrations.AddField(
            model_name='ogcservice',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_ogcservice_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='ogcservice',
            name='licence',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='This is the contact for the metadata information.', on_delete=django.db.models.deletion.RESTRICT, related_name='metadata_contact_ogcservice_metadata', related_query_name='metadata_contact_ogcservice_metadata', to='registry.metadatacontact', verbose_name='metadata contact'),
        ),
        migrations.AddField(
            model_name='ogcservice',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_ogcservice_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='ogcservice',
            name='polymorphic_ctype',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_registry.ogcservice_set+', to='contenttypes.contenttype'),
        ),
        migrations.AddField(
            model_name='ogcservice',
            name='service_contact',
            field=models.ForeignKey(help_text='This is the contact for the service provider.', on_delete=django.db.models.deletion.RESTRICT, related_name='service_contact_ogcservice_metadata', related_query_name='service_contact_ogcservice_metadata', to='registry.metadatacontact', verbose_name='service contact'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddField(
            ...
            name='created_by_user',
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_mapcontextlayer_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='mapcontextlayer',
        ...
        migrations.AddField(
            model_name='mapcontextlayer',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_mapcontextlayer_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='mapcontextlayer',
            name='layer_style',
        ...
        migrations.AddField(
            model_name='mapcontextlayer',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_mapcontextlayer_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='mapcontextlayer',
            name='parent',
        ...
        migrations.AddField(
            model_name='mapcontext',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_mapcontext_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='legendurl',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_legendurl_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='legendurl',
            name='style',
        ...
        migrations.AddField(
            model_name='layerconformitycheckrun',
            name='created_by_user',
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_layerconformitycheckrun_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='layerconformitycheckrun',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_layerconformitycheckrun_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='layerconformitycheckrun',
            name='layer',
        ...
        migrations.AddField(
            model_name='layerconformitycheckrun',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_layerconformitycheckrun_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='layer',
            name='created_by_user',
        ...
        migrations.AddField(
            model_name='layer',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_layer_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='layer',
            name='parent',
        ...
        migrations.AddField(
            model_name='harvestresult',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_harvestresult_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='featuretypeelement',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_featuretypeelement_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='featuretypeconformitycheckrun',
            name='created_by_user',
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_featuretypeconformitycheckrun_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='featuretypeconformitycheckrun',
            name='feature_type',
        ...
        migrations.AddField(
            model_name='featuretypeconformitycheckrun',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_featuretypeconformitycheckrun_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='featuretypeconformitycheckrun',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_featuretypeconformitycheckrun_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='featuretype',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_featuretype_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='featuretype',
            name='reference_systems',
        ...
        migrations.AddField(
            model_name='dimension',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_dimension_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='datasetmetadatarelation',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_datasetmetadatarelation_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='datasetmetadataconformitycheckrun',
            name='created_by_user',
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_datasetmetadataconformitycheckrun_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='datasetmetadataconformitycheckrun',
            name='dataset_metadata',
        ...
        migrations.AddField(
            model_name='datasetmetadataconformitycheckrun',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_datasetmetadataconformitycheckrun_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='datasetmetadataconformitycheckrun',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_datasetmetadataconformitycheckrun_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='datasetmetadata',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_datasetmetadata_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='datasetmetadata',
            name='reference_systems',
        ...
        migrations.AddField(
            model_name='analyzedresponselog',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_analyzedresponselog_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='analyzedresponselog',
            name='response',
        ...
        migrations.AddField(
            model_name='allowedoperation',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_allowedoperation_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='allowedoperation',
        ...
        migrations.AddConstraint(
            model_name='datasetmetadata',
            constraint=models.UniqueConstraint(fields=('dataset_id', 'dataset_id_code_space'), name='registry_datasetmetadata_unique_dataset_id_dataset_id_code_space'),
        ),
    ]
