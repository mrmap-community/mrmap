    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_unit', models.CharField(choices=[(None, '---'), ('MPx', 'MPx'), ('Ft', 'Ft')], help_text='The unit in which the entity count is stored.', max_length=5)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key_file', models.FileField(editable=False, upload_to=resourceNew.models.security.key_file_path)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.FileField(upload_to=resourceNew.models.security.request_body_path)),
                ('headers', models.JSONField(default=dict)),
                ('auth_was_used', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headers', models.JSONField(default=dict)),
                ('url', models.URLField(max_length=4096)),
                ('content', models.FileField(upload_to=resourceNew.models.security.response_content_path)),
            ],
        ),
        migrations.CreateModel(
            name='Keyword',
