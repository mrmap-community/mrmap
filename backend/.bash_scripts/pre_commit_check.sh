...
flake8 --ignore E501,W503,W504 /opt/mrmap/ --exclude /opt/mrmap/tests/
...
cmp /opt/mrmap/locale/de/LC_MESSAGES/django.po /opt/mrmap/locale/de/LC_MESSAGES/django.po.bak -n 325
