    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('average_response_time', models.DurationField(help_text='statistic information about the average response duration of this operation', verbose_name='avarage response time')),
                ('parameter_info', models.JSONField(editable=False, help_text='For harvesting csw we need the maximum requestable records per request for example. This is configured by the csw provider and differs. This and other information will be stored inside this field.', verbose_name='parameter info')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('record_type', models.CharField(choices=[('dataset', 'dataset'), ('service', 'service'), ('tile', 'tile'), ('series', 'series')], default='dataset', help_text='the type of the record, which shall be harvested.', max_length=10, verbose_name='record type')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'historical catalouge services',
        ...
        migrations.AddField(
            ...
            name='dataset_metadata',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='You can use this field to pre filter possible Layer selection.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.datasetmetadata', verbose_name='Dataset Metadata'),
        ),
        migrations.AddField(
            model_name='historicalmapcontextlayer',
            name='history_relation',
        ...
        migrations.AddField(
            ...
            name='csw',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dataset_metadata_relations', related_query_name='dataset_metadata_relation', to='registry.catalogueservice'),
        ),
        migrations.AddField(
            model_name='datasetmetadatarelation',
            name='dataset_metadata',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, editable=False, help_text='all services from which this dataset was harvested.', related_name='dataset_metadata', related_query_name='dataset_metadata', through='registry.DatasetMetadataRelation', to='registry.catalogueservice', verbose_name='services'),
        ),
        migrations.AddField(
            model_name='datasetmetadata',
