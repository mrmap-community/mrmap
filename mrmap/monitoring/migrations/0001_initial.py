    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monitoring_monitoringresult_created', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('last_modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monitoring_monitoringresult_lastmodified', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.DurationField(blank=True, null=True)),
                ('created_by_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monitoring_monitoringrun_created', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('last_modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monitoring_monitoringrun_lastmodified', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
                ('metadatas', models.ManyToManyField(related_name='monitoring_runs', to='service.Metadata', verbose_name='Checked resources')),
                ('owned_by_org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='monitoring_monitoringrun_owned', to='structure.organization', verbose_name='Owner')),
            ],
            options={
