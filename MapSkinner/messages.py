...
GROUP_SUCCESSFULLY_DELETED = _("Group <strong>{}</strong> successfully deleted.")
GROUP_SUCCESSFULLY_EDITED = _("Group <strong>{}</strong> successfully edited.")
...
ORGANIZATION_SUCCESSFULLY_EDITED = _("Organization <strong>{}</strong> successfully edited.")

SERVICE_REGISTRATION_ABORTED = _("The service registration for <strong>{}</strong> was canceled")
