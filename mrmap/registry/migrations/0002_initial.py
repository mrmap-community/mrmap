...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='service',
            name='keywords',
            field=models.ManyToManyField(help_text='all keywords which are related to the content of this metadata.', related_name='service_metadata', related_query_name='service_metadata', to='registry.Keyword', verbose_name='keywords'),
        ),
        migrations.AddField(
            model_name='service',
            name='last_modified_by',
