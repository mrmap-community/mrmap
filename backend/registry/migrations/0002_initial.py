...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='wmsconformitycheckrun',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_wmsconformitycheckrun_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='timeextent',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_timeextent_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='style',
            name='created_by_user',
        ...
        migrations.AddField(
            model_name='style',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_style_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='serviceauthentication',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceauthentication_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='serviceauthentication',
            name='service',
            field=models.OneToOneField(blank=True, help_text='the optional authentication type and credentials to request the service.', on_delete=django.db.models.deletion.CASCADE, related_name='auth', related_query_name='auth', to='registry.ogcservice', verbose_name='web map service'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='serviceaccessgroup',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceaccessgroup_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='ruleset',
            name='rules',
        ...
        migrations.AddField(
            model_name='remotemetadata',
            name='owner',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_remotemetadata_owner', to='auth.group', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='remotemetadata',
            name='service',
