    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('describes', models.ForeignKey(help_text='the service where this remote metadata is related to. This remote metadata was found in the GetCapabilites document of the related service.', on_delete=django.db.models.deletion.CASCADE, related_name='remote_metadata', related_query_name='remote_metadata', to='registry.catalogueservice', verbose_name='catalogue service')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, help_text='the topic categories of the dataset', related_name='%(class)s_metadata', related_query_name='%(class)s_metadata', to='registry.isocategory', verbose_name='categories')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('languages', models.ManyToManyField(blank=True, help_text='languages used for documenting metadata', related_name='%(class)s_metadata', related_query_name='%(class)s_metadata', to='registry.language', verbose_name='languages')),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['begin'],
                'indexes': [django.contrib.postgres.indexes.BTreeIndex(fields=['begin', 'end'], name='registry_ti_begin_d8533c_btree'), models.Index(fields=['resolution'], name='registry_ti_resolut_040c18_idx')],
                'constraints': [models.CheckConstraint(condition=models.Q(models.Q(('begin', models.F('end'))), models.Q(('end__gte', models.F('begin')), ('is_relative', False)), models.Q(('begin__isnull', True), ('end__isnull', True), ('is_relative', True), ('resolution__isnull', False)), _connector='OR'), name='kind_check'), models.UniqueConstraint(fields=('begin', 'end', 'resolution', 'is_relative'), name='registry_timeextent_unique_timerange_resolution')],
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('default_reference_system', models.ForeignKey(blank=True, db_constraint=False, help_text='the default reference system for this feature type', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='as_default_featuretypes', to='registry.referencesystem', verbose_name='default reference system')),
