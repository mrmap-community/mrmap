...
if  ! grep -q "        'PASSWORD': '$mrmap_db_pw',"  /opt/mrmap/mrmap/MrMap/sub_settings/db_settings.py ;then
	sed -i "/        'USER': '$mrmap_db_user',/a \        \'PASSWORD': '$mrmap_db_pw'," /opt/mrmap/mrmap/MrMap/sub_settings/db_settings.py
fi
