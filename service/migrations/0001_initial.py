    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_groups', models.ManyToManyField(related_name='allowed_operations', to='structure.MrMapGroup')),
                ('operations', models.ManyToManyField(related_name='secured_operations', to='service.OGCOperation')),
                ('secured_metadata', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='secured_operations', to='service.metadata')),
            ],
        ),
        migrations.CreateModel(
