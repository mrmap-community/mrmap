...
def create_gmd_identification_info(metadata: Metadata):
    ...
    gmd_md_data_identification = _create_gmd_md_data_identification(
        gmd_citation="",  # ToDo
...
def _create_gmd_md_data_identification(
        gmd_citation: str,
        gmd_abstract: str,
        gmd_language: str,
        gmd_purpose: str = "",
...
def _create_gmd_md_keywords(
        gco_character_string: str,
        gmd_type: str = "",
        gmd_thesaurus_name: str = ""
):
    content = (
        f"{gco_character_string}"
        f"{gmd_type}"
