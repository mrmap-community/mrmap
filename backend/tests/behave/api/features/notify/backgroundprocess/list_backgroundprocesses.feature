...
Feature: BackgroundProcess List Endpoint
    ...
    Scenario: Can get list of current background processes
        ...
        Then I expect that response json has an attribute "data.[0].attributes.progress" with value "100.0"
        Then I expect that response json has an attribute "data.[1].attributes.runningThreads" with value "1"
        ...
        Then I expect that response json has an attribute "data.[1].attributes.progress" with value "81.25"
        Then I expect that response json has an attribute "data.[2].attributes.runningThreads" with value "2"
        ...
        Then I expect that response json has an attribute "data.[2].attributes.pendingThreads" with value "1"
        Then I expect that response json has an attribute "data.[2].attributes.progress" with value "50.0"
