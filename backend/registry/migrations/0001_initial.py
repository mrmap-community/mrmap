    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.OneToOneField(blank=True, help_text='the optional authentication type and credentials to request the service.', on_delete=django.db.models.deletion.CASCADE, related_name='auth', related_query_name='auth', to='registry.ogcservice', verbose_name='web map service')),
            ],
            options={
                'abstract': False,
            },
