# Generated by Django 5.0rc1 on 2023-12-04 14:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_vector', models.GeneratedField(db_persist=True, expression=django.contrib.postgres.search.SearchVector(models.F('title'), models.F('abstract'), models.F('file_identifier'), config='english'), output_field=django.contrib.postgres.search.SearchVectorField())),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='', help_text='identifier of the remote data', max_length=4096)),
                ('code_space', models.CharField(blank=True, default='', help_text='code space for the given identifier', max_length=4096)),
                ('title', models.CharField(default='', help_text='a short descriptive title for this metadata', max_length=1000, verbose_name='title')),
                ('abstract', models.TextField(default='', help_text='brief summary of the content of this metadata.', verbose_name='abstract')),
                ('file_identifier', models.CharField(db_index=True, default=uuid.uuid4, editable=False, help_text='the parsed file identifier from the iso metadata xml (gmd:fileIdentifier) OR for example if it is a layer/featuretypethe uuid of the described layer/featuretype shall be used to identify the generated iso metadata xml.', max_length=1000, verbose_name='file identifier')),
                ('search_vector', models.GeneratedField(db_persist=True, expression=django.contrib.postgres.search.SearchVector(models.F('title'), models.F('abstract'), models.F('file_identifier'), models.F('code'), models.F('code_space'), config='english'), output_field=django.contrib.postgres.search.SearchVectorField())),
            ],
        ),
        migrations.CreateModel(
            name='Style',
