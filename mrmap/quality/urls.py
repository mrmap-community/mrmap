...
from .views import ConformityCheckRunCreateView, ConformityCheckRunListView, conformity_check_report_download, \
    ConformityCheckRunDeleteView
...
urlpatterns = [
    ...
    path('runs/<pk>/report', conformity_check_report_download, name='conformity_check_run_report'),
]
