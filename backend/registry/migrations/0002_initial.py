...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_wmsconformitycheckrun_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='wmsconformitycheckrun',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_wmsconformitycheckrun_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='wmsconformitycheckrun',
            name='owned_by_org',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_wmsconformitycheckrun_owned_by_org', to='users.organization', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='wmsconformitycheckrun',
            name='service',
        ...
        migrations.AddField(
            ...
            name='created_by_user',
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_webmapservice_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='webmapservice',
            name='keywords',
            field=models.ManyToManyField(help_text='all keywords which are related to the content of this metadata.', related_name='webmapservice_metadata', related_query_name='webmapservice_metadata', to='registry.Keyword', verbose_name='keywords'),
        ),
        migrations.AddField(
            model_name='webmapservice',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_webmapservice_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='webmapservice',
            name='licence',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='This is the contact for the metadata information.', on_delete=django.db.models.deletion.RESTRICT, related_name='metadata_contact_webmapservice_metadata', related_query_name='metadata_contact_webmapservice_metadata', to='registry.metadatacontact', verbose_name='metadata contact'),
        ),
        migrations.AddField(
            model_name='webmapservice',
            name='owned_by_org',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_webmapservice_owned_by_org', to='users.organization', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='webmapservice',
            name='service_contact',
            field=models.ForeignKey(help_text='This is the contact for the service provider.', on_delete=django.db.models.deletion.RESTRICT, related_name='service_contact_webmapservice_metadata', related_query_name='service_contact_webmapservice_metadata', to='registry.metadatacontact', verbose_name='service contact'),
        ),
        migrations.AddField(
            model_name='webfeatureservice',
            name='created_by_user',
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_webfeatureservice_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='webfeatureservice',
            name='keywords',
            field=models.ManyToManyField(help_text='all keywords which are related to the content of this metadata.', related_name='webfeatureservice_metadata', related_query_name='webfeatureservice_metadata', to='registry.Keyword', verbose_name='keywords'),
        ),
        migrations.AddField(
            model_name='webfeatureservice',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_webfeatureservice_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='webfeatureservice',
            name='licence',
        ...
        migrations.AddField(
            model_name='webfeatureservice',
            name='metadata_contact',
            field=models.ForeignKey(help_text='This is the contact for the metadata information.', on_delete=django.db.models.deletion.RESTRICT, related_name='metadata_contact_webfeatureservice_metadata', related_query_name='metadata_contact_webfeatureservice_metadata', to='registry.metadatacontact', verbose_name='metadata contact'),
        ),
        migrations.AddField(
            model_name='webfeatureservice',
            name='owned_by_org',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_webfeatureservice_owned_by_org', to='users.organization', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='webfeatureservice',
            name='service_contact',
            field=models.ForeignKey(help_text='This is the contact for the service provider.', on_delete=django.db.models.deletion.RESTRICT, related_name='service_contact_webfeatureservice_metadata', related_query_name='service_contact_webfeatureservice_metadata', to='registry.metadatacontact', verbose_name='service contact'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='serviceauthentication',
            name='created_by_user',
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceauthentication_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='serviceauthentication',
            name='csw',
            field=models.OneToOneField(blank=True, help_text='the optional authentication type and credentials to request the service.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auth', related_query_name='auth', to='registry.catalougeservice', verbose_name='catalouge service'),
        ),
        migrations.AddField(
            model_name='serviceauthentication',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceauthentication_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='serviceauthentication',
            name='owned_by_org',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_serviceauthentication_owned_by_org', to='users.organization', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='serviceauthentication',
            name='wfs',
        ...
        migrations.AddField(
            model_name='registerwebmapservice',
            name='registering_for_organization',
            field=models.ForeignKey(help_text="Select for which organization you'd like to register the service.", on_delete=django.db.models.deletion.DO_NOTHING, to='users.organization', verbose_name='Registration for organization'),
        ),
        ...
        migrations.AddField(
            model_name='operationurl',
            name='wms_service',
            field=models.ForeignKey(editable=False, help_text='the web map service for that this url can be used for.', on_delete=django.db.models.deletion.CASCADE, related_name='operation_urls', related_query_name='operation_url', to='registry.webmapservice', verbose_name='related web map service'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddField(
            model_name='layerconformitycheckrun',
            name='owned_by_org',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_layerconformitycheckrun_owned_by_org', to='users.organization', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='layer',
            name='created_by_user',
        ...
        migrations.AddField(
            model_name='layer',
            name='service',
            field=models.ForeignKey(editable=False, help_text='the extras service where this element is part of', on_delete=django.db.models.deletion.CASCADE, related_name='service', related_query_name='service', to='registry.webmapservice', verbose_name='service'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='featuretypeconformitycheckrun',
            name='owned_by_org',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_featuretypeconformitycheckrun_owned_by_org', to='users.organization', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='featuretype',
            name='service',
            field=models.ForeignKey(editable=False, help_text='the extras service where this element is part of', on_delete=django.db.models.deletion.CASCADE, related_name='service', related_query_name='service', to='registry.webfeatureservice', verbose_name='service'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='datasetmetadataconformitycheckrun',
            name='owned_by_org',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_datasetmetadataconformitycheckrun_owned_by_org', to='users.organization', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='created_by_user',
            field=models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_catalougeservice_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by'),
        ),
        migrations.AddField(
            model_name='catalougeservice',
            name='keywords',
        ...
        migrations.AddField(
            model_name='catalougeservice',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_catalougeservice_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by'),
        ),
        migrations.AddField(
            model_name='catalougeservice',
            name='licence',
        ...
        migrations.AddField(
            model_name='catalougeservice',
            name='metadata_contact',
            field=models.ForeignKey(help_text='This is the contact for the metadata information.', on_delete=django.db.models.deletion.RESTRICT, related_name='metadata_contact_catalougeservice_metadata', related_query_name='metadata_contact_catalougeservice_metadata', to='registry.metadatacontact', verbose_name='metadata contact'),
        ),
        migrations.AddField(
            model_name='catalougeservice',
            name='owned_by_org',
            field=models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registry_catalougeservice_owned_by_org', to='users.organization', verbose_name='Owner'),
        ),
        migrations.AddField(
            model_name='catalougeservice',
            name='service_contact',
            field=models.ForeignKey(help_text='This is the contact for the service provider.', on_delete=django.db.models.deletion.RESTRICT, related_name='service_contact_catalougeservice_metadata', related_query_name='service_contact_catalougeservice_metadata', to='registry.metadatacontact', verbose_name='service contact'),
        ),
        migrations.AddField(
            model_name='buildwebmapservicetask',
            name='job',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='build_service_task', related_query_name='build_service_task', to='registry.registerwebmapservice'),
        ),
        migrations.AddField(
