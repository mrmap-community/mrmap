# Generated by Django 3.1.8 on 2021-06-14 11:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spatial_res_type', models.CharField(choices=[('groundDistance', 'groundDistance'), ('scaleDenominator', 'groundDistance')], help_text='Ground resolution in meter or the equivalent scale.', max_length=20, null=True, verbose_name='resolution type')),
                ...
                ('dataset_id_code_space', models.CharField(help_text='code space for the given identifier', max_length=4096, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text='the xml as string.', verbose_name='content')),
                ('is_original', models.BooleanField(default=False, help_text='check if this document is the original xml.', verbose_name='is original?')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='all reference systems which this element supports', related_name='layer', related_query_name='layer', to='resourceNew.ReferenceSystem', verbose_name='reference systems'),
        ),
        migrations.AddField(
            model_name='layer',
            name='service',
        ...
        migrations.AddField(
            model_name='featuretype',
            name='reference_systems',
            field=models.ManyToManyField(blank=True, help_text='all reference systems which this element supports', related_name='featuretype', related_query_name='featuretype', to='resourceNew.ReferenceSystem', verbose_name='reference systems'),
        ),
        migrations.AddField(
            model_name='featuretype',
            name='service',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='the metadata object which is parsed from this xml.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='documents', related_query_name='document', to='resourceNew.datasetmetadata', verbose_name='related dataset metadata'),
        ),
        migrations.AddField(
            model_name='document',
            name='feature_type_metadata',
            field=models.ForeignKey(blank=True, help_text='the metadata object which is parsed from this xml.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='documents', related_query_name='document', to='resourceNew.featuretypemetadata', verbose_name='related feature type metadata'),
        ),
        migrations.AddField(
            model_name='document',
            name='last_modified_by',
        ...
        migrations.AddField(
            model_name='document',
            name='layer_metadata',
            field=models.ForeignKey(blank=True, help_text='the metadata object which is parsed from this xml.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='documents', related_query_name='document', to='resourceNew.layermetadata', verbose_name='related layer metadata'),
        ),
        migrations.AddField(
            model_name='document',
            name='owned_by_org',
        ...
        migrations.AddField(
            model_name='document',
            name='service',
            field=models.ForeignKey(blank=True, help_text='the service object which is described by this document.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='documents', related_query_name='document', to='resourceNew.service', verbose_name='related service'),
        ),
        migrations.AddField(
            model_name='document',
            name='service_metadata',
            field=models.ForeignKey(blank=True, help_text='the metadata object which is parsed from this xml.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='documents', related_query_name='document', to='resourceNew.servicemetadata', verbose_name='related dataset metadata'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='document',
            constraint=models.UniqueConstraint(fields=('service', 'service_metadata', 'layer_metadata', 'feature_type_metadata', 'dataset_metadata', 'is_original'), name='resourcenew_document_one_original'),
        ),
        migrations.AddConstraint(
            model_name='document',
