    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.ForeignKey(help_text='Select the service you want to subscribe. When you edit an existing subscription, you can not change this selection.', on_delete=django.db.models.deletion.CASCADE, to='resourceNew.service', verbose_name='Service')),
                ('owned_by_org', models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users_subscription_owned_by_org', to='structure.organization', verbose_name='Owner')),
