    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords_list', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=300), default=list, size=None)),
                ('search_vector', models.GeneratedField(db_persist=True, expression=django.contrib.postgres.search.SearchVector(models.F('title'), models.F('abstract'), models.Func('keywords_list', function='array_to_tsvector', output_field=django.contrib.postgres.search.SearchVectorField()), config='english'), output_field=django.contrib.postgres.search.SearchVectorField())),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abstract', models.TextField(default='', help_text='brief summary of the content of this metadata.', verbose_name='abstract')),
                ('file_identifier', models.CharField(db_index=True, default=uuid.uuid4, editable=False, help_text='the parsed file identifier from the iso metadata xml (gmd:fileIdentifier) OR for example if it is a layer/featuretypethe uuid of the described layer/featuretype shall be used to identify the generated iso metadata xml.', max_length=1000, verbose_name='file identifier')),
                ('search_vector', models.GeneratedField(db_persist=True, expression=django.contrib.postgres.search.SearchVector(models.F('title'), models.F('abstract'), models.F('file_identifier'), models.F('code'), models.F('code_space'), models.Func('keywords_list', function='array_to_tsvector', output_field=django.contrib.postgres.search.SearchVectorField()), config='english'), output_field=django.contrib.postgres.search.SearchVectorField())),
            ],
        ),
        migrations.CreateModel(
            name='Style',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset_metadata', models.ForeignKey(blank=True, help_text='the related dataset metadata of this dimension entity', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dataset_metadata_dimensions', related_query_name='dataset_metadata_dimension', to='registry.datasetmetadatarecord', verbose_name='dataset metadata')),
                ('feature_type', models.ForeignKey(blank=True, help_text='the related feature type of this dimension entity', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feature_type_dimensions', related_query_name='feature_type_dimension', to='registry.featuretype', verbose_name='feature type')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('existing_dataset_records', models.ManyToManyField(editable=False, related_name='ignored_by', to='registry.datasetmetadatarecord')),
                ('new_dataset_records', models.ManyToManyField(editable=False, related_name='harvested_by', to='registry.datasetmetadatarecord')),
                ('service', models.ForeignKey(help_text='the csw for that this job is running', on_delete=django.db.models.deletion.CASCADE, to='registry.catalogueservice', verbose_name='service')),
                ('updated_dataset_records', models.ManyToManyField(editable=False, related_name='updated_by', to='registry.datasetmetadatarecord')),
            ],
            options={
                'ordering': ['-done_at'],
        ...
        migrations.AddField(
            ...
            name='secured_service',
            field=models.OneToOneField(help_text='the security proxy settings for this service.', on_delete=django.db.models.deletion.CASCADE, related_name='proxy_setting', related_query_name='proxy_setting', to='registry.webfeatureservice', verbose_name='proxy settings'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='secured_service',
            field=models.OneToOneField(help_text='the security proxy settings for this service.', on_delete=django.db.models.deletion.CASCADE, related_name='proxy_setting', related_query_name='proxy_setting', to='registry.webmapservice', verbose_name='proxy settings'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='service',
            field=models.ForeignKey(help_text='this is the service which shall be monitored', on_delete=django.db.models.deletion.CASCADE, related_name='monitoring_results', related_query_name='monitoring_result', to='registry.webmapservice', verbose_name='web map service'),
        ),
        migrations.AddField(
            model_name='wmsgetcapabilitiesresult',
            name='task_result',
        ...
        migrations.AddIndex(
            model_name='catalogueservice',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='registry_ca_search__2e213c_gin'),
        ),
        migrations.AddConstraint(
            model_name='catalogueserviceoperationurl',
        ...
        migrations.AddIndex(
            model_name='datasetmetadatarecord',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='registry_da_search__7a3c56_gin'),
        ),
        migrations.AddConstraint(
            model_name='datasetmetadatarecord',
            constraint=models.UniqueConstraint(condition=models.Q(('code', ''), ('code_space', ''), _negated=True), fields=('code', 'code_space'), name='registry_datasetmetadatarecord_unique_together_code__and_code_space'),
        ),
        migrations.AddConstraint(
            model_name='datasetmetadatarecord',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('spatial_res_type', ''), ('spatial_res_value', None)), models.Q(('spatial_res_type', 'groundDistance'), ('spatial_res_value__gte', 0)), models.Q(('spatial_res_type', 'scaleDenominator'), ('spatial_res_value__gte', 0)), _connector='OR'), name='registry_datasetmetadatarecord_check_spatial_res'),
        ),
        migrations.AddConstraint(
            model_name='datasetmetadatarecord',
        ...
        migrations.AddConstraint(
            model_name='datasetmetadatarecord',
            constraint=models.CheckConstraint(check=models.Q(('keywords_list__contains', ['']), _negated=True), name='registry_datasetmetadatarecord_non_empty_lexeme_inside_keywords_list'),
        ),
        migrations.AddConstraint(
            model_name='harvestingjob',
        ...
        migrations.AddIndex(
            model_name='webfeatureservice',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='registry_we_search__3bae48_gin'),
        ),
        migrations.AddIndex(
            model_name='featuretype',
        ...
        migrations.AddIndex(
            model_name='featuretype',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='registry_fe_search__6f193f_gin'),
        ),
        migrations.AddConstraint(
            model_name='allowedwebfeatureserviceoperation',
        ...
        migrations.AddIndex(
            model_name='webmapservice',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='registry_we_search__f1681b_gin'),
        ),
        migrations.AddIndex(
            model_name='servicemetadatarecord',
        ...
        migrations.AddIndex(
            model_name='servicemetadatarecord',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='registry_se_search__2b20f5_gin'),
        ),
        migrations.AddConstraint(
            model_name='servicemetadatarecord',
            constraint=models.UniqueConstraint(condition=models.Q(('code', ''), ('code_space', ''), _negated=True), fields=('code', 'code_space'), name='registry_servicemetadatarecord_unique_together_code__and_code_space'),
        ),
        migrations.AddConstraint(
            model_name='servicemetadatarecord',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('spatial_res_type', ''), ('spatial_res_value', None)), models.Q(('spatial_res_type', 'groundDistance'), ('spatial_res_value__gte', 0)), models.Q(('spatial_res_type', 'scaleDenominator'), ('spatial_res_value__gte', 0)), _connector='OR'), name='registry_servicemetadatarecord_check_spatial_res'),
        ),
        migrations.AddConstraint(
            model_name='servicemetadatarecord',
        ...
        migrations.AddConstraint(
            model_name='servicemetadatarecord',
            constraint=models.CheckConstraint(check=models.Q(('keywords_list__contains', ['']), _negated=True), name='registry_servicemetadatarecord_non_empty_lexeme_inside_keywords_list'),
        ),
        migrations.AddConstraint(
            model_name='metadatarelation',
        ...
        migrations.AddIndex(
            model_name='layer',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_vector'], name='registry_la_search__2654c3_gin'),
        ),
        migrations.AddConstraint(
            model_name='allowedwebmapserviceoperation',
