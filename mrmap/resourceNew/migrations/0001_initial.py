    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_identifier', models.CharField(editable=False, help_text='the parsed file identifier from the iso metadata xml (gmd:fileIdentifier) OR for example if it is a layer/featuretypethe uuid of the described layer/featuretype shall be used to identify the generated iso metadata xml.', max_length=1000, null=True, verbose_name='file identifier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True, help_text='The timestamp of the creation date of this object.', verbose_name='Created at')),
                ('last_modified_at', models.DateTimeField(auto_now=True, db_index=True, help_text='The timestamp of the last modification of this object', verbose_name='Last modified at')),
                ('xml', models.TextField(help_text='the xml as string.', verbose_name='xml')),
                ('xml_backup', models.TextField(help_text='the original xml as backup to restore the xml field.', verbose_name='xml backup')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True, help_text='The timestamp of the creation date of this object.', verbose_name='Created at')),
                ('last_modified_at', models.DateTimeField(auto_now=True, db_index=True, help_text='The timestamp of the last modification of this object', verbose_name='Last modified at')),
                ('operation', models.CharField(choices=[(None, '---'), ('GetCapabilities', 'GetCapabilities'), ('GetMap', 'GetMap'), ('GetFeatureInfo', 'GetFeatureInfo'), ('DescribeLayer', 'DescribeLayer'), ('GetLegendGraphic', 'GetLegendGraphic'), ('GetStyles', 'GetStyles'), ('PutStyles', 'PutStyles'), ('GetFeature', 'GetFeature'), ('Transaction', 'Transaction'), ('LockFeature', 'LockFeature'), ('DescribeFeatureType', 'DescribeFeatureType'), ('GetFeatureWithLock', 'GetFeatureWithLock'), ('GetGmlObject', 'GetGmlObject'), ('ListStoredQueries', 'ListStoredQueries'), ('GetPropertyValue', 'GetPropertyValue'), ('DescribeStoredQueries', 'DescribeStoredQueries'), ('GetRecords', 'GetRecords'), ('DescribeRecord', 'DescribeRecord'), ('GetRecordById', 'GetRecordById')], max_length=100)),
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(help_text='the configured service for this proxy settings', on_delete=django.db.models.deletion.CASCADE, related_name='proxy_settings', related_query_name='proxy_setting', to='resourceNew.service', verbose_name='configured service'),
        ),
        migrations.AddField(
            model_name='proxysetting',
            name='created_by_user',
        ...
        migrations.AddField(
            ...
            name='allowed_groups',
            field=models.ManyToManyField(related_name='allowed_operations', related_query_name='allowed_operation', to='resourceNew.ServiceAccessGroup'),
        ),
        migrations.AddField(
            model_name='allowedoperation',
            name='created_by_user',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='Select one or more feature types.', related_name='allowed_operations', related_query_name='allowed_operation', to='resourceNew.FeatureType', verbose_name='secured feature types'),
        ),
        migrations.AddField(
            model_name='allowedoperation',
            name='secured_layers',
            field=models.ManyToManyField(blank=True, help_text='Select one or more layers. Note that all sub layers of a selected layer will also be secured.', related_name='allowed_operations', related_query_name='allowed_operation', to='resourceNew.Layer', verbose_name='secured layers'),
        ),
        migrations.AddField(
            model_name='allowedoperation',
            name='secured_service',
