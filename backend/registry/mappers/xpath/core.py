...
xpath. To understand how this module builds the lexer and parser, it is
helpful to understand how the `ply <http://www.dabeaz.com/ply/>`_ module
works.

Note that most client applications will import htese objects from
xpath, not directly from here."""
...
from .ast import serialize, AST

__all__ = ["lexer", "parser", "parse", "serialize"]

# build the lexer. This will generate a lextab.py in the xpath directory.
# Unfortunately, xpath requires some wonky lexing.
...
# build the parser. This will generate a parsetab.py in the xpath directory.
# Unlike lex, though, this just logs a complaint when it fails
