...
If you encounter any issues installing or using MrMap, try one of the
...
* **Ideas** - Ideas for new functionality that isn't yet ready for a formal
  feature request
* **Q&A** - Request help with installing or using MrMap


## Reporting Bugs

* First, ensure that you're running the [latest stable version](https://github.com/mrmap-community/mrmap/releases)
of MrMap. If you're running an older version, it's possible that the bug has
already been fixed.

* Next, check the GitHub [issues list](https://github.com/mrmap-community/mrmap/issues)
...
provide all information request in the issue template, including:
    ...
    * The environment in which MrMap is running
...
* First, check the GitHub [issues list](https://github.com/mrmap-community/mrmap/issues)
...
any proposals which substantially extend MrMap's functionality beyond its
...
[issue intake policy](https://github.com/mrmap-community/mrmap/wiki/Issue-Intake-Policy).

## Submitting Pull Requests

* If you're interested in contributing to MrMap, be sure to check out our
[getting started](https://mrmap.readthedocs.io/en/stable/development/getting-started/)
documentation for tips on setting up your development environment.

* Be sure to open an issue **before** starting work on a pull request, and
discuss your idea with the MrMap maintainers before beginning work. This will
...
New issues are handled according to our [issue intake policy](https://github.com/mrmap-community/mrmap/wiki/Issue-Intake-Policy).
