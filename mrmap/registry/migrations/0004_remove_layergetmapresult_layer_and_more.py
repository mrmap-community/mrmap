    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('setting', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s', related_query_name='%(app_label)s_%(class)ss', to='registry.webmapservicemonitoringsetting', verbose_name='Run')),
            ],
            options={
                'abstract': False,
            },
