...
=======
                ('activation_until', models.DateTimeField(default=datetime.datetime(2021, 4, 10, 9, 56, 32, 671094, tzinfo=utc))),
...
<<<<<<< HEAD
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pending_publish_requests', to='structure.mrmapgroup')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pending_publish_requests', to='structure.organization')),
            ],
        ),
=======
>>>>>>> cc6b21af7f0e12c81a045cc53f7959a2f36f6be3
...
=======
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('message', models.TextField(blank=True, null=True)),
                ('activation_until', models.DateTimeField(default=datetime.datetime(2021, 4, 10, 9, 56, 32, 672093, tzinfo=utc))),
                ('created_on', models.DateTimeField(auto_now_add=True)),
