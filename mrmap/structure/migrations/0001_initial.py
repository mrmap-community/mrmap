...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': [django.db.models.expressions.Case(django.db.models.expressions.When(status='STARTED', then=0), django.db.models.expressions.When(status='PENDING', then=1), django.db.models.expressions.When(status='SUCCESS', then=2), django.db.models.expressions.When(status='FAILURE', then=3)), '-date_done'],
            },
