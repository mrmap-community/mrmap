# Generated by Django 5.0rc1 on 2023-12-04 13:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_vector', models.GeneratedField(db_persist=True, expression=django.contrib.postgres.search.SearchVector('title', 'abstract', config='english'), output_field=django.contrib.postgres.search.SearchVectorField())),
