...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('structure', '0002_auto_20210412_2055'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='structure.organization', verbose_name='Data provider')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='auth.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_service', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child_services', to='service.service')),
                ('published_for', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='published_for', to='structure.organization', verbose_name='Published for')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-timestamp'],
                'permissions': [('download_logs', 'Can download logs')],
            },
        ),
        migrations.CreateModel(
            name='MimeType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_metadata', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_metadatas', to='service.metadata')),
                ('to_metadata', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_metadatas', to='service.metadata')),
            ],
        ),
        migrations.AddField(
            model_name='metadata',
