...
# perform login
curl -v -k -c cookies.txt -b cookies.txt $host --data "username=$user&next=&password=$password&next=&next=&next="
...
# actual registration
curl -k -v -c cookies.txt -b cookies.txt $host/service/add/ --data "page=2&is_form_update=False&ogc_request=GetCapabilities&ogc_service=wms&ogc_version=${array[VERSION]}&uri=$url&registering_with_group=$group&registering_for_other_organization="
