...
ToDo: description
"""
from service.helper.iso.iso19115.md_data_identification import create_gmd_identification_info
from mrmap.service.helper.iso.iso19115.xml_creation import NS_GMD, create_xml_element, create_xml_doc
...
def create_gmd_md_metadata(metadata: Metadata, organization: Organization):
    ...
    gmd_md_metadata = _create_gmd_md_metadata(
...
def create_gmd_contact(organization: Organization):
    ...
    gmd_ci_responsible_party = create_gmd_ci_responsible_party(
        gmd_organisation_name="",  # ToDo
...
def create_gmd_ci_responsible_party(
        gmd_role: str,
