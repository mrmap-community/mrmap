    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('settings', models.JSONField(default=accounts.models.users.get_settings_default, help_text='json storage on backend to provide configurations for frontends.', verbose_name='settings')),
