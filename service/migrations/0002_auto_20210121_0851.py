...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='securedoperation',
            name='operations',
            field=models.ManyToManyField(related_name='secured_operations', to='service.OGCOperation'),
        ),
        migrations.AddField(
            model_name='securedoperation',
            name='secured_metadata',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='secured_operations', to='service.metadata'),
        ),
