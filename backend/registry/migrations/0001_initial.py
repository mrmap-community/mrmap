# Generated by Django 5.2.8 on 2026-01-06 10:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.CheckConstraint(condition=models.Q(models.Q(('begin', models.F('end'))), models.Q(('end__gte', models.F('begin')), ('is_relative', False)), models.Q(('begin__isnull', True), ('end__isnull', True), ('is_relative', True), ('resolution__isnull', False)), _connector='OR'), name='kind_check'), models.UniqueConstraint(fields=('begin', 'end', 'resolution'), name='registry_timeextent_unique_timerange_resolution')],
            },
        ),
        migrations.AddField(
