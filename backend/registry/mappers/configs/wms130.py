        ...
        "service": {
            ...
            "fields": {
                ...
                "operation_urls": {
                    ...
                    "_identifier": {
                        "xpath": "./wms:Capability/wms:Request/wms:{operation}/wms:DCPType/wms:HTTP/wms:{method}",
                    },
                },
                "keywords": {
