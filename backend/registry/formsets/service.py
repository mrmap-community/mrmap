...
from registry.forms.security import ExternalAuthenticationModelForm, ProxySettingModelForm
from registry.models.security import ExternalAuthentication, ProxySetting
