...
from service.models import Service, MapContext
...
class RegisterNewResourceWizardPage2(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['registering_for_organization'].queryset = self.request.user.get_publishable_organizations().filter(is_autogenerated=False)
