...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='layer',
            name='service',
            field=models.ForeignKey(editable=False, help_text='the main service where this element is part of', on_delete=django.db.models.deletion.CASCADE, related_name='layer', related_query_name='layer', to='resourceNew.service', verbose_name='parent service'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='featuretypeelement',
            name='feature_type',
            field=models.ForeignKey(editable=False, help_text='related feature type of this element', on_delete=django.db.models.deletion.CASCADE, related_name='elements', related_query_name='element', to='resourceNew.featuretype', verbose_name='feature type'),
        ),
        migrations.AddField(
            model_name='featuretypeelement',
            name='last_modified_by',
        ...
        migrations.AddField(
            model_name='featuretypeelement',
            name='owned_by_org',
            field=models.ForeignKey(blank=True, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resourcenew_featuretypeelement_owned_by_org', to='structure.organization', verbose_name='Owner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='featuretype',
            name='service',
            field=models.ForeignKey(editable=False, help_text='the main service where this element is part of', on_delete=django.db.models.deletion.CASCADE, related_name='featuretype', related_query_name='featuretype', to='resourceNew.service', verbose_name='parent service'),
        ),
        migrations.AddField(
