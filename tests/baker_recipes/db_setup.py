...
def create_wms_service(group: Group, how_much_services: int = 1, how_much_sublayers: int = 1):
...
def create_wfs_service(group: Group, how_much_services: int = 1, how_much_featuretypes: int = 1):
