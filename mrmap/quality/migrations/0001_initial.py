# Generated by Django 3.2.4 on 2021-07-28 07:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_user', models.ForeignKey(blank=True, editable=False, help_text='The user who has created this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quality_conformitycheckrun_created_by_user', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('last_modified_by', models.ForeignKey(blank=True, editable=False, help_text='The last user who has modified this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quality_conformitycheckrun_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
                ('metadata', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resourceNew.datasetmetadata')),
                ('owned_by_org', models.ForeignKey(blank=True, editable=False, help_text='The organization which is the owner of this object.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quality_conformitycheckrun_owned_by_org', to='structure.organization', verbose_name='Owner')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('conformitycheckconfiguration_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='quality.conformitycheckconfiguration')),
                ('mandatory_rule_sets', models.ManyToManyField(related_name='mandatory_rule_sets', to='quality.RuleSet')),
                ('optional_rule_sets', models.ManyToManyField(blank=True, related_name='optional_rule_sets', to='quality.RuleSet')),
            ],
            bases=('quality.conformitycheckconfiguration',),
        ),
    ]
