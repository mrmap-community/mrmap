    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('get_capabilities_url', models.URLField(help_text='this shall be the full get capabilities request url.', validators=[MrMap.validators.validate_get_capablities_uri], verbose_name='Service url')),
                ('collect_linked_metadata', models.BooleanField(default=True, help_text='auto start collecting task after successful registering which register all linked metadata records found in the GetCapabilities document.', verbose_name='collect metadata')),
                ('username', models.CharField(help_text='the username used for the authentication.', max_length=255, null=True, verbose_name='username')),
                ('password', models.CharField(help_text='the password used for the authentication.', max_length=500, null=True, verbose_name='password')),
                ('auth_type', models.CharField(choices=[(None, '---'), ('http_basic', 'http_basic'), ('http_digest', 'http_digest')], help_text='kind of authentication mechanism shall used.', max_length=12, null=True, verbose_name='authentication type')),
            ],
            options={
                'abstract': False,
            },
